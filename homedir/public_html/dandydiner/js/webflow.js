...
Webflow.require('ix').init([
  {"slug":"click-menu","name":"click-menu","value":{"style":{},"triggers":[{"type":"click","selector":".modal","stepsA":[{"display":"block","opacity":0},{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none"}]}]}}
]);
